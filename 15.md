...
<h2>Aplicabilidade no Projeto Java</h2>

A **Collection ArrayList** será utilizada para simular um Banco de dados no Projeto Java. Ela armazenará os Objetos das Classes do seu projeto em memória. Veja o exemplo abaixo, no projeto Conta Bancária:
...
public class Menu {
	...
	public static void main(String[] args) {
		...
		/*
		 * Cria a Collection ArrayList contendo Objetos da Classe Conta, chamado
		 * listConta
		 */
		ArrayList<Conta> listConta = new ArrayList<Conta>();

		/* Cria um Objeto da Classe ContaCorrente */
		ContaCorrente conta = new ContaCorrente(1, "123", 1, "João da Silva", 1000f, 100.0f);

		/*
		 * Adiciona o Objeto conta na lista listConta Observe que como a Classe Conta é
		 * a Superclasse da Classe ContaCorrente (herança), eu posso adicionar os
		 * Objetos da Subclasse ContaCorrente, que é um tipo de Conta.
		 */
		listConta.add(conta);

		/* Exibe a Mensagem de confirmação da inserção */
		System.out.println("\n Conta numero: " + conta.getNumero() + " criada com sucesso!");

		/* Exibe os dados da Conta. Como foi o primeiro o primeiro
		 * objeto inserido na lista, ele estará na posição zero.
		 * O ideal é criar uma Método de busca para achar a posição
		 * do Objeto conta na lista.
		 */
		listConta.get(0).visualizar();
